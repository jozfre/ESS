            ...
            <div class="card card-dark">
              <div class="card-header">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-primary btn-sm float-right" onclick="location.href='update-space.php'"><i class="fas fa-edit"></i> Update Details</button>
                </div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="spaceType" class="form-control" id="spaceType" value="Prayer Hall" readonly>
                  </div>
                  <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalLabel">Delete Space</h5>
      </div>
