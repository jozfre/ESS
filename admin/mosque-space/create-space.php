...
if (isset($_POST['submit'])) {
  ...
  if (in_array($fileType, ['image/jpeg', 'image/jpg', 'image/png'])) {
    ...
    // Insert into database using mysqli_query
    $sql = "INSERT INTO space (spaceName, spaceCapacity, spaceType, spacePicture) 
    ...
    if (mysqli_query($conn, $sql)) {
      ...
      header("Location: create-space.php");
      exit();
    }
  } else {
              ...
              <div class="card card-success">
                ...
                <form name="form" method="POST" action="create-space.php" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="spaceImage">Space Image (Max 5MB)</label>
                      <div class="custom-file">
                        <input type="file" name="spaceImage" class="form-control" id="spaceImage" accept=".jpg,.jpeg,.png" required>
